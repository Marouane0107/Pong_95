...
function initializeGame() {
	...
	async function saveGameResult(winner) {
		...
		try {
			...
			console.log('Matchmaking game result saved successfully:', result);
			resultSaved = true;
		} catch (error) {
	...
	async function saveTournamentResult(winner) {
		...
		try {
			...
			const result = await response.json();
			console.log('Tournament game result saved successfully:', result);
			resultSaved = true;
		} catch (error) {
			console.error('Failed to save tournament game result:', error);
		}
	}
